...
###########################################
vennPlot <- function(counts=counts, mymain="Venn Diagram", mysub="default", setlabels="default", yoffset=seq(0,10,by=0.34), ccol=rep(1,31), colmode=1, lcol=c("darkolivegreen4", "dodgerblue3", "firebrick2", "tan3", "khaki4"), lines=c("darkolivegreen4", "dodgerblue3", "firebrick2", "tan3", "khaki4"), mylwd=3, diacol=1, type="ellipse", ccex=1.0, lcex=1.0, sepsplit="_", ...) {
